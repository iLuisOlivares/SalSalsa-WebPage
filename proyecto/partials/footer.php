<section class="seccionFooter">
    <div style="display: inline; padding-left:500px">
        <a href="nosotros.php" style="text-decoration:none; padding-left:50px; padding-right:10px; color:white;">Nosotros</a>
