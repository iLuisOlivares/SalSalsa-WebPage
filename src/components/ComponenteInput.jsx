...
function ComponenteInput({estado,cambiarEstado, label,placeholder,leyenda,expresionRegular}) {
  ...
  const validacion = () =>{
    ...
    return (
        ...
        <InputStyled valido={estado.valido} type="text" value= {estado.campo} onChange={onChange} onKeyUp = {validacion} onBlur={validacion} placeholder = {placeholder} className="form-control" id=""></InputStyled>
