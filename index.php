        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active anchoImagenCa" data-bs-interval="10000">
                    <img class="d-block w-100" src="img/fotoCar1.png" alt="First slide" class="anchoImagenCa" id="anchoImagenCaId">
                ...
                <div class="carousel-item" data-bs-interval="15000">
                    <img class="d-block w-100" src="img/fotoCa.png" alt="First slide" class="anchoImagenCa" id="anchoImagenCaId">
                    <div class="carousel-caption d-none d-md-block textCarrucel">
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="img/fotoDescripcionDos.png" alt="First slide" class="anchoImagenCa" id="anchoImagenCaId">
                    <div class="carousel-caption d-none d-md-block textCarrucel">
